...
<body style="background-image: url('${pageContext.servletContext.contextPath }/images/bg.jpg');margin-top:0px;">
	...
	<div id="loginbox" style="padding-top: 3%; width:355px;">
		<form id="loginform" name="loginform" class="form-vertical"
			...
			action="loginSales.jspx"
			method="post">
			<div class="control-group normal_text">
				<table style="width: 100%">
					<tr>
						<td align="left"></td>
							<td align="center" style="background: #64CDBD;font-weight: bold;color: #FFFFFF;font-size:20px;">课课经纪人管理中心</td>
						<td align="right"></td>
					</tr>
				</table>
			</div>
			...
			<div style="padding-left: 8%;padding-right: 8%;" >
				<div class="controls">
					<div class="pull-left">
						<a href="toregisterSales.jspx" style="font-size:12px;color: #64CDBD;" id="to-recover">注册</a>
					</div>
					<div class="pull-right">
				    	<a href="toupdSales.jspx" style="font-size:12px;color: #64CDBD;" id="to-recover">忘记密码</a>
				    </div>
				</div>
				<div class="main_input_box">
