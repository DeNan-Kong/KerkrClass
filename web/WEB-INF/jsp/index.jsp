...
<%@page import="com.bayan.keke.util.*"%>
<html lang="en" class="app">
	...
	//}
         $(function() {
  			...
  			//tb.load(rootPath+ "/taskSubject.jspx?subjectType=${subjectType}&grade=${grade}&province=${province}&vip=${vip}");
  			tb.load(rootPath+ "/teaTongjiManage.jspx?teacherId=${userId}");
  			$("[nav-n]").each(function () {
...
.logob {
	...
	<body class="" style="">
		...
		<div class="navbar-header aside-md">
			...
			<a href="#" class="navbar-brand" data-toggle="fullscreen">课课经纪人管理中心</a>
		...
		<ul class="nav navbar-nav hidden-xs">
			<li class="dropdown">
				...
				<div class="wrapper lter m-t-n-xs">
					<a href="index.html#" class="thumb pull-left m-r"> </a>
					<div class="clear">
			...
			<li>
				<div class="m-t m-l">
					<%--<a href="index.jsp" class="dropdown-toggle btn btn-xs btn-primary"
		...
		<ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
			<li class="hidden-xs">
				<%--<a href="index.jsp#" class="dropdown-toggle dk"
				...
				<div class="list-group list-group-alt animated fadeInRight">
					...
					<a href="index.jsp#" class="media list-group-item"> <span
						class="pull-left thumb-sm"></span> <span
				...
				<a href="index.jsp#" class="pull-right"><i class="fa fa-cog"></i>
				</a>
				<a href="iindex.jsp#notes"
			...
			<li class="dropdown hidden-xs">
				<%--<a href="index.jsp#" class="dropdown-toggle dker"
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu animated fadeInRight">
					...
					<li>
						<a href="logoutManage.jspx?teacherId=${userId}">退出</a>
					</li>
				</ul>
			</li>
		</ul>
			...
			<ul class="nav">
				...
				<li class="active">
					<a href="javascript:void(0)" class="active"> <i
						class=" fa fa-dashboard icon"> <b class="logob bg-danger"></b>
					</i> <span class="pull-right"> <i class="fa fa-angle-down text"></i>
							<i class="fa fa-angle-up text-active"></i> </span> <span>首页</span> </a>
					<ul class="nav lt">
					    <li class="active">
                            <a href="javascript:void(0)" class="active"
                                nav-n="首页,统计,/teaTongjiManage.jspx?teacherId=${userId}"> <i
                                class="fa fa-angle-right"></i> <span>统计</span> </a>
                        </li>
                        <li class="active">
                            <a href="javascript:void(0)" class="active"
                                nav-n="首页,明细,/toSidUserListManage.jspx"> <i
                                class="fa fa-angle-right"></i> <span>明细</span> </a>
                        </li>
                        <li class="active">
                            <a href="javascript:void(0)" class="active"
                                nav-n="首页,提现,/toWithdrawPageManage.jspx?teacherId=${userId}"> <i class="fa fa-angle-right"></i>
                                <span>提现</span> </a>
                        </li>
                        <li class="active">
                            <a href="javascript:void(0)" class="active"
                                nav-n="首页,修改密码,/toinupdateSales.jspx">
                                <i class="fa fa-angle-right"></i> <span>修改密码</span> </a>
                        </li>
                        <li class="active">
                            <a href="javascript:void(0)" class="active"
                                nav-n="首页,修改资料,/toupdateSales.jspx">
                                <i class="fa fa-angle-right"></i> <span>修改资料</span> </a>
                        </li>
                        <li class="active">
                            <a href="logoutManage.jspx?teacherId=${userId}" class="active">
