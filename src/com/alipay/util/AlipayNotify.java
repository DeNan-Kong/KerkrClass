...
public class AlipayNotify {
     ...
     * @return 验证结果
     */
    public static boolean verifyDirect(Map<String, String> params) {
    	...
    	String sign = "";
    	if(params.get("sign") != null) {sign = params.get("sign");}
    	boolean isSign = getSignVeryfyDirect(params, sign);
     ...
     * @return 生成的签名结果
     */
	private static boolean getSignVeryfyDirect(Map<String, String> Params, String sign) {
    	//过滤空值、sign与sign_type参数
    	Map<String, String> sParaNew = AlipayCore.paraFilter(Params);
        //获取待签名字符串
        String preSignStr = AlipayCore.createLinkString(sParaNew);
